...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cred.location'
        db.add_column(u'cred_cred', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cred.label'
        db.add_column(u'cred_cred', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cred.location'
        db.delete_column(u'cred_cred', 'location')

        # Deleting field 'Cred.label'
        db.delete_column(u'cred_cred', 'label')
